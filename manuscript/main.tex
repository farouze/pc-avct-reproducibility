...
The companion reproducibility package contains executable rerun and statistical-analysis scripts, preserved V26 helper functions, pinned dependencies, input SHA-256 hashes, model-selection manifests, and regenerated aggregate outputs. Locally retained row predictions and paired participant contrasts support result checking under the dataset access conditions. The public code archive excludes participant-level data. A public repository DOI remains to be assigned to the archived code release; the dataset DOI below identifies data, not this implementation.
